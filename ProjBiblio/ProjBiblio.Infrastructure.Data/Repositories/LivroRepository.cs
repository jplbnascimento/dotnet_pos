...
namespace ProjBiblio.Infrastructure.Data.Repositories {
    public class LivroRepository : Repository<Livro>, ILivroRepository {
        ...
        public IEnumerable<Livro> GetLivrosPorCampanha (int marketingID) {
            return _context.Livro
                .Include (l => l.LivMarketing)
                .Where (l => l.LivMarketing.Any (la => la.MarketingID == marketingID));
        }
        ...
        public void DeleteLivrosMarketing (int livroID) {
            var livrosMarketing = _context.CampanhaMarketingLivro.AsNoTracking ()
                .Where (la => la.LivroID == livroID);

            _context.CampanhaMarketingLivro.RemoveRange (livrosMarketing);
        }
    }
}